...
[built-in options]
c_args = ['-I$workdir/mesa/shims/include', '-I$workdir/mesa/shims']
cpp_args = ['-I$workdir/mesa/shims/include', '-I$workdir/mesa/shims']
c_link_args = ['-I$workdir/mesa/shims/include', '-I$workdir/mesa/shims']
cpp_link_args = ['-I$workdir/mesa/shims/include', '-I$workdir/mesa/shims']
